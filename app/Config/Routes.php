...
$routes->get('appointments/(:segment)', 'Features::bookApp/$1',['filter' => 'auth']);
$routes->match(['get', 'post'], 'appointments/book', 'Features::book',['filter' => 'auth']);
$routes->match(['get', 'post'], 'appointments/checkAvailable', 'Features::checkAvailable');
$routes->match(['get', 'post'], 'appointments/getInfo', 'Features::getInfo',['filter' => 'auth']);
