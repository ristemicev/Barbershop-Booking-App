        ...
        <div class="col-md-6 offset-md-3 border p-4 shadow bg-light">
            ...
            <form action="" id="appointmentForm">
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        <select class="form-select" aria-label="Pick a time" id="izbor" disabled required
                    ...
                    <input type="text" name="b_id" id="b_id" class="form-control"
                           value="<?php echo $barbershop['result1'][0]['id'] ?>"
                           hidden>
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <button type="button" class="btn btn-outline-secondary float-end me-2 back">Cancel</button>
                    </div>
                </div>
            </form>
        </div>
